...
/* ----------------------------------------------------------------------
   ...
   Code based off that tokenizer.cpp file in LAMMPS made by
 ...
 * i.e. the first non-seperator character */
 ...
 *
 * \param str      String to be processed
 * \param separators String with separator characters
 * 
...
/*! Indicate whether more tokens are available
 * 
 * \return true if there are moer tokens, false if not */
...
/*! Retrieve enxt token and convert to int
 *
